...
<div id="tw" class="truckswrap" style="background-color:#000;">
	...
	<div style="position:relative;background-color:#fff; padding: 30px;margin:0 auto;">
			...
			<div style="max-width:400px;font-weight:bold;">
				Type your full name:
				<input type="text" name="printname" placeholder="Type your full name" >
			</div>
			...
			<div style="max-width:400px;font-weight:bold;margin-bottom:20px;">
				Emergency Contact 1:
				<input type="text" name="ec1name" placeholder="Name">
				<input type="text" name="ec1rel" placeholder="Relationship">
				<input type="text" name="ec1phone" placeholder="Telephone">
			</div>
			
			<div style="max-width:400px;font-weight:bold;margin-bottom:20px;">
				Emergency Contact 2:
				<input type="text" name="ec2name" placeholder="Name">
				<input type="text" name="ec2rel" placeholder="Relationship">
				<input type="text" name="ec2phone" placeholder="Telephone">
			</div>
			
			<div style="max-width:400px;font-weight:bold;margin-bottom:20px;">
				Emergency Contact 3:
				<input type="text" name="ec3name" placeholder="Name">
				<input type="text" name="ec3rel" placeholder="Relationship">
				<input type="text" name="ec3phone" placeholder="Telephone">
			</div>
			
			
			<div style="max-width:400px;font-weight:bold;margin-bottom:20px;">
				Minor Information:
				<input type="text" name="minorname" placeholder="Minor's Name">
...
<div id="ctsholder">
	...
	<button style="margin-top:40px;" type=button onclick="window.location.href='login.php';">Close Without Signing</button>
